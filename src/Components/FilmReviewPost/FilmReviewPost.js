...
function FilmReviewPost(props) {
  ...
  useEffect(() => {
    ...
    const post = FilmData.find((post) => post.slug === slug);
    setPost(post);
    setSlug(slug);
  }, [post, props.match.params.slug]);

  return (
    <div className="filmReviewPost">
      <img
      ...
      <div className="filmReviewPost__details">
        <div className="filmReviewPost__details__left">
          ...
          <img
            ...
            src={`${starPathStart}${post.rating}Pink${starPathEnd}`}
            alt={props.rating}
          />
          <h3>"{post.quote}"</h3>
        </div>
      ...
      <div className="filmReviewPost__verdict">
        <img
          ...
          alt={post.title}
        />
        <div className="filmReviewPost__verdict__text">
